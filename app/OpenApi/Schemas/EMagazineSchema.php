...
class EMagazineSchema extends SchemaFactory implements Reusable
{
    /**
    ...
    {
        return Schema::object('EMagazine')
            ->properties(
                Schema::string('id')->default(null),
                Schema::string('month_id')->default(null),
                Schema::string('thumbnail')->default(null),
                Schema::string('start_data_edition')->default(null),
                Schema::string('title')->default(null),
                Schema::string('short_content')->default(null),
