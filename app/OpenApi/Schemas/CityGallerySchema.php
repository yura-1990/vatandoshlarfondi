...
class CityGallerySchema extends SchemaFactory implements Reusable
{
    /**
    ...
    {
        return Schema::object('CityGallery')
            ->properties(
                ...
                Schema::string('download')->default(null),
                Schema::string('share')->default(null),
